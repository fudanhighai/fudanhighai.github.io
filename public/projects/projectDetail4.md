...
### 1、带有提示信息的智能问答
#### 从网页中找到包含对应的信息的界面
![qaarch](./images/page_fdu.png)
#### 将提示信息与要提问的问题拼接共同输入ChatGPT进行提问

- #### 示例1-信息抽取任务
    
![qaarch](./images/prompt_QA1.jpg)
- #### 示例2-总结概括任务
![qaarch](./images/prompt_QA2.jpg)

### 2、无提示信息智能问答
直接将待询问的问题输入ChatGPT
- #### 示例1
![qaarch](./images/QA1.jpg)
- #### 示例2
![qaarch](./images/QA3.jpg)
...
- #### 示例1
![qaarch](./images/QA_error1.png)

- #### 示例2
![qaarch](./images/QA_error2.png)

- #### 示例3
![qaarch](./images/QA_error3.png)

- #### 示例4
![qaarch](./images/QA_error4.png)
